 ...
 * Project :      ADM Global
 *
 * Date Created : Tuesday, February 23, 2016 15:56:48
...
CREATE TABLE Pessoa_Usina(
    ...
    nu_Matricula          varchar(11)     NULL,
    nu_Cpf                char(11)        NULL,
    de_Ramais             varchar(30)     NULL,
    dt_Nascimento         datetime        NULL,
    cd_Sexo               char(1)         NULL,
    cd_EMailPessoa        varchar(255)    NULL,
...
CREATE TABLE Usuario_Seguranca(
    ...
    tp_FormatoSenha                int             CONSTRAINT [DF__aspnet_Me__Passw__164452B1] DEFAULT ((0)) NOT NULL,
    cd_EmailSeguranca              varchar(255)    NULL,
...
CREATE TABLE Usuario_Usina(
    ...
    fl_AtivoUsuUsi        bit             DEFAULT 1 NOT NULL,
...
CREATE UNIQUE INDEX UK_Perfil_Sistema_nm_PerSis ON Perfil_Sistema(nm_PerSis)
go
...
/* 
 * INDEX: UK_Pessoa_Usina_nu_Matricula 
 */

CREATE UNIQUE INDEX UK_Pessoa_Usina_nu_Matricula ON Pessoa_Usina(nu_Matricula)
go
IF EXISTS (SELECT * FROM sys.indexes WHERE object_id=OBJECT_ID('Pessoa_Usina') AND name='UK_Pessoa_Usina_nu_Matricula')
    PRINT '<<< CREATED INDEX Pessoa_Usina.UK_Pessoa_Usina_nu_Matricula >>>'
ELSE
    PRINT '<<< FAILED CREATING INDEX Pessoa_Usina.UK_Pessoa_Usina_nu_Matricula >>>'
go
...
CREATE UNIQUE INDEX IDX_Usuario_Seguranca__Usuario_Usina ON Usuario_Seguranca(Id_UsuUsi)
go
...
ALTER TABLE UsuarioUsi_PerSis ADD CONSTRAINT FK_Usuario_PerSis__Perfil_Sistema 
    FOREIGN KEY (id_PerSis)
    REFERENCES Perfil_Sistema(id_PerSis)
go

ALTER TABLE UsuarioUsi_PerSis ADD CONSTRAINT FK_Usuario_PerSis__Usuario_Usina 
    FOREIGN KEY (Id_UsuUsi)
    REFERENCES Usuario_Usina(Id_UsuUsi)
go
...
ALTER TABLE UsuarioUsi_Sistema ADD CONSTRAINT FK_Usuario_Sistema__Sistema 
    FOREIGN KEY (id_Sistema)
    REFERENCES Sistema(id_Sistema)
go

ALTER TABLE UsuarioUsi_Sistema ADD CONSTRAINT FK_Usuario_Sistema__Usuario_Usina 
    FOREIGN KEY (Id_UsuUsi)
    REFERENCES Usuario_Usina(Id_UsuUsi)
go
